...
/**
 * Soft gate for future signed-in-only actions (e.g. cloud progress sync).
 * Practice itself stays open — do not call this from lesson typing flows.
 *
 * Returns true when the action may proceed; false after redirecting to sign-in.
 * Skipped in DEV so local editing stays frictionless (no shared krumath.com cookies).
 */
